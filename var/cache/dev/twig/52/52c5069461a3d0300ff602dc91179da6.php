...
class __TwigTemplate_4cf034b8509b8e2ca055df32d834493c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<form method=\"post\" class=\"float-right\" action=\"";
...
";
    ...
    {
        return new Source("<form method=\"post\" class=\"float-right\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn btn-outline-danger\">Borrar</button>
</form>
", "user/_delete_form.html.twig", "/home/lorena/LRJ/lrj/templates/user/_delete_form.html.twig");
    }
}
