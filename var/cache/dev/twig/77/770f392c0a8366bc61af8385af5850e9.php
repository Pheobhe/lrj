...
class __TwigTemplate_d1b1eead33dc13789410405bdb9d4370 extends Template
{
    private $source;
    private $macros = [];
...
<li class=\"breadcrumb-item\"><a>Personas</a></li>
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 11
        echo "<a href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_persona_new");
        echo "\" class=\"btn btn-outline-primary \">Crear Nuevo</a>

<div class=\"card\">
    <div class=\"card-body\">
        <h5><i class=\"feather icon-package\"></i> Listado de Personas</h5>
        <hr />
         <table class=\"table\">
...
\t\t\t\t\t";
        // line 20
        echo $this->extensions['HelloSebastian\HelloBootstrapTableBundle\Twig\BootstrapTableTwigExtension']->helloBootstrapTableRender($this->env, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 20, $this->source); })()));
        echo "\t
  \t\t\t\t</table>
\t\t\t</div>
\t\t</table>
...
";
    ...
    {
        return array (  186 => 35,  181 => 34,  171 => 33,  159 => 29,  154 => 28,  144 => 27,  128 => 20,  115 => 11,  105 => 10,  91 => 6,  81 => 5,  62 => 3,  39 => 1,);
    }
...
{% block body %}
<a href=\"{{ path('app_persona_new') }}\" class=\"btn btn-outline-primary \">Crear Nuevo</a>
...
", "persona/index.html.twig", "/home/lorena/LRJ/lrj/templates/persona/index.html.twig");
    }
}
