...
$(document).ready(function(){
    ...
    $('#filer_input_single').filer({
        extensions: ['jpg', 'jpeg', 'png', 'gif', 'psd','pdf','doc','docx','xlsx','xls'],
        changeInput: true,
        showThumbs: true,
        addMore: false
    });
    ...
    $('#filer_input').filer({
        ...
        captions: {
            button: "Archivos",
            feedback: "Seleccione archivos",
            feedback2: "files were chosen",
            drop: "Drop file here to Upload",
            removeConfirmation: "Esta seguro que desea eliminar el archivo",
            errors: {
                filesLimit: "Se permiten  {{fi-limit}} archivos al mismo tiempo",
                filesType: "Formato de archivo no permitido",
                filesSize: "{{fi-name}} archivo muy pesado . Tamaño maximo {{fi-maxSize}} MB.",
                filesSizeAll: "{{fi-name}} archivos muy pesados . Tamaño maximo {{fi-maxSize}} MB."
            }
        }
    });
